...
public class SeriesFragment extends Fragment {
    ...
    private static final String endpoint = "https://gateway.marvel.com/v1/public/series?";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_viewsr);
    ...
    private void fetchImages() {
        pDialog.setMessage("Getting Series....");
        pDialog.show();

        StringRequest req = new StringRequest (endpoint+"ts="+ts+"&apikey="+url+"&hash="+hash+"&title=Deadpool", new Response.Listener<String>() {
            @Override
