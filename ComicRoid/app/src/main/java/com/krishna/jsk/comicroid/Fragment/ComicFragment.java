...
public class ComicFragment extends Fragment {
    ...
    private static final String endpoint = "https://gateway.marvel.com/v1/public/comics?";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_viewco);
    ...
    private void fetchImages() {
        pDialog.setMessage("Getting Comics....");
        pDialog.show();

        StringRequest req = new StringRequest (endpoint+"ts="+ts+"&apikey="+url+"&hash="+hash+"&title=Wolverine&limit=100", new Response.Listener<String>() {
            @Override
